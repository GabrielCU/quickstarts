...
Let's start by downloading the needed files for this tutorial. Download these 4 attachments and upload them in your Notebook 
...
7. Import the PMML into ModelOps
...
image::dataset_template.png[ModelOps projects screenshot, width=100%]
...
image::training_dataset_basic.png[ModelOps projects screenshot, width=100%]
...
image::training_dataset.png[ModelOps projects screenshot, width=100%]

Confirm the query and click on create.

=== Create Evaluation dataset

image::evaluation_dataset_basic.png[ModelOps projects screenshot, width=100%]
...
image::evaluation_dataset.png[ModelOps projects screenshot, width=100%]

Confirm the query and click on create.

== Model Lifecycle for a new BYOM

Download and unzip the BYOM_v7 notebook, links are at the top of the guide. For PMML file you can also download a PMML generated in the training of a GIT model.
...
=== Train a model and export to PMML

We will show you how to train a model and how to convert it to PMML and ONNX open formats. We provide the necessary code in the BYOM_v7 so you can follow along through this guide.
...
Go to your project and click on DEFINE BYOM MODEL

Enter the name and description for the model and select PMML as the format

Click on save model

image::BYOM_model.png[ModelOps projects screenshot, width=100%]
